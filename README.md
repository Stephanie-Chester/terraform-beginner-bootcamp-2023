...
- This will allow us an easier time to debug and execute a manual Terraform CLI install.
...
We need to be careful when using the Init command because it will not rerun if we restart an existing workspace.
